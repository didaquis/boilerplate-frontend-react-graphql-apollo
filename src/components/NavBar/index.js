...
import { MdHome, MdPeopleOutline, MdPersonOutline } from 'react-icons/md'
...
export const NavBar = () => {
	return (
		<nav className="navbar navbar-expand-lg navbar-dark bg-primary justify-content-between d-flex mb-4">
			...
			<Link className="navbar-brand text-light font-weight-bold" to='/user-administration'><MdPeopleOutline size={SIZE}/></Link>
